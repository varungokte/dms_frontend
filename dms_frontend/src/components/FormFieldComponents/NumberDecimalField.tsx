...
function NumberDecimalField(props:{index:number|string, type?:"curr"|"rate", id:string, name: string, required?:boolean, disabled?:boolean, prefillValues:any, setPrefillValues:Function, className?:string, repeatFields?:boolean, formIndex?:number, enableDecimal?:boolean }){
  return (
    <div key={props.index} className="mb-5 mx-2">
      ...
      <input id={props.id} name={props.name} type="number"
        ...
        value={props.repeatFields
          ?props.prefillValues[props.formIndex||0][props.id]?Number(props.prefillValues[props.formIndex||0][props.id]):""
          :props.prefillValues[props.id]!==undefined?Number(props.prefillValues[props.id]):""
        }
