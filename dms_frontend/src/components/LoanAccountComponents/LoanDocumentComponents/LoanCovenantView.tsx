...
function LoanCovenantView(props:{priority:string,covData:any,label:string, fieldList:FieldAttributesList, editCovenantFunction:Function, deleteCovenantFunction:Function, addFileFunction:Function, deleteFileFunction:Function, getFileListFunction:Function}){
  return (
