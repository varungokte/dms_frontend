...
function TableCollapsible(props:{index:number,topRow:[string,string][], bottomRow:[string|ReactElement,string][], content:ReactElement, searchString:string, showTabs:boolean[], setShowTabs:Function}){
  return(
    <div>
